...
# define SKYFIREWORLD_CONFIG_VERSION 2026230600
#endif
#ifndef SKYFIREAUTH_CONFIG_VERSION
# define SKYFIREAUTH_CONFIG_VERSION 2026310600
#endif
...
# ifdef _WIN64
#  define _FULLVERSION _PACKAGENAME " rev. " SKYFIRE_VER_PRODUCTVERSION_STR " (Win64, " _BUILD_DIRECTIVE ")"
# else
#  define _FULLVERSION _PACKAGENAME " rev. " SKYFIRE_VER_PRODUCTVERSION_STR " (Win32, " _BUILD_DIRECTIVE ")"
# endif
#else
