...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUSY_TRADE,                                   0x14E0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBusyTradeOpcode                     ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ENABLE_NAGLE,                                 0x12B3, STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess                      ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_FINAL_NOTIFY,                      0x1063, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetFinalNotify                ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_INPUT,                             0x17BA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetInput                      ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT,        0x19C2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleQueueProposeMatchResult   ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_QUIT_NOTIFY,                       0x1C45, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetQuitNotify                 ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_REQUEST_PVP,                       0x02C7, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleRequestPvp                 ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_REQUEST_UPDATE,                    0x0377, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetRequestUpdate              ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_SET_FRONT_PET,                     0x1A07, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetInputFirstPet              ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_STOP_PVP_MATCHMAKING,              0x08C1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleStopPvpMatchmaking         ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REALM_SPLIT, 0x0062, STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleRealmSplitOpcode); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ZONEUPDATE, 0x0265, STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleZoneUpdateOpcode);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PURCHASE_LIST, 0x18B2, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL); //5.4.8 18414 - not implemented; client may poll Battle Pay purchases
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_ACHIEVEMENT_TRACKING, 0x0CF0, STATUS_LOGGEDIN, PROCESS_INPLACE, &WorldSession::HandleGuildSetAchievementTracking); // 5.4.8 18414 - client sends current guild achievement tracking list
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PET_SLOT, 0x10A7, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_LOGIN_FAILED,              0x1A0B, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_REMOVED_SPELL, 0x1CAE, STATUS_NEVER);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SUPERCEDED_SPELL, 0x1943, STATUS_NEVER);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DISPLAY_GAME_ERROR, 0x181F, STATUS_NEVER);
