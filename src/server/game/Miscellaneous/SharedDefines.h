...
enum GameObjectDynamicLowFlags
{
    ...
    GO_DYNFLAG_LO_INVERTED_MOVEMENT = 0x40        // Transport movement is reversed
};
...
enum ActivateTaxiReply
{
    ...
    ERR_TAXI_NO_SUCH_PATH = 2,
    ERR_TAXI_NOT_ENOUGH_MONEY = 3,
    ERR_TAXI_TOO_FAR_AWAY = 4,
    ERR_TAXI_NO_VENDOR_NEARBY = 5,
    ERR_TAXI_NOT_VISITED = 6,
    ERR_TAXI_PLAYER_BUSY = 7,
    ERR_TAXI_PLAYER_ALREADY_MOUNTED = 8,
    ERR_TAXI_PLAYER_SHAPESHIFTED = 9,
    ERR_TAXI_PLAYER_MOVING = 10,
    ERR_TAXI_SAME_NODE = 11,
